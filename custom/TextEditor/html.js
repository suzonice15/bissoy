...
<head>
    ...
    <style>
        * {outline: 0px solid transparent;-webkit-tap-highlight-color: rgba(0,0,0,0);-webkit-touch-callout: none;}
        ...
        body { overflow-y: hidden; -webkit-overflow-scrolling: touch;background-color: #FFF;}
        ...
        .txte { height: 100%;}
        .txte-content { outline: 0; overflow-y: auto;padding: 10px;}
...
<body>
<div class="content"><div id="editor" class="txte"></div></div>
<script>
    (function (exports) {
        ...
        var Actions = {
            ...
            h1: {
                state: function() {
                    return queryCommandState('formatBlock');
                },
                result: function() {
            ...
            link: {
                result: function(url) {
                    if(!url) url = window.prompt('Enter the link URL');
                    if (url) exec('createLink', url);
                }
            },
            image: {
                result: function(url) {
                    if (url) { exec('insertHTML', "<br><div><img src='"+ url +"'/></div><br>"); Actions.UPDATE_HEIGHT(); }
                }
            },
            content: {
        ...
        var init = function init(settings) {
            ...
            content.className = "txte-content";
